    ...
    QGCFlickable {
        ...
        Column {
            ...
            QGCLabel {
                ...
                text:           setupComplete ?
                    qsTr("Aqui se encontram informações gerais sobre o drone. No lado esquerdo é possível acessar o menu de Sensores.") :
                    qsTr("ATENÇÃO: O drone precisa de calibração antes de iniciar o vôo.")
